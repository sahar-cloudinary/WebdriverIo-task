    ...
    createReport() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.reports.length) {
                this.options.LOG.error(typescript_string_operations_1.String.Format("Empty report array"));
            }
            ...
            try {
                ...
                if (this.options.showInBrowser) {
                    yield open(reportData.reportFile);
                    this.options.LOG.info("browser launched");
                }
                this.options.LOG.info("Report Aggregation completed");
                return yield new Promise((resolve, reject) => setTimeout(resolve, 3000));
            }
            catch (ex) {
